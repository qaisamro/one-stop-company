...
const AdminCompanyIntro = () => {
    ...
    const fetchIntro = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`http://localhost:5000/api/company-intro?lang=${form.language}`, {
    ...
    const handleAddImage = async () => {
        ...
        try {
            ...
            await axios.post('http://localhost:5000/api/company-intro/image', formData, {
                headers: {
    ...
    const handleUpdateContent = async () => {
        ...
        try {
            const response = await axios.put('http://localhost:5000/api/company-intro', {
                title: form.title,
    ...
    const handleDeleteImage = async (index) => {
        setLoading(true);
        try {
            await axios.delete(`http://localhost:5000/api/company-intro/image/${index}`, {
                headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
