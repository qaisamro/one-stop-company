...
const AdminCompanyIntro = () => {
    ...
    const fetchIntro = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`https://one-stop.ps/api/company-intro?lang=${form.language}`, {
    ...
    const handleAddImage = async () => {
        ...
        try {
            ...
            await axios.post('https://one-stop.ps/api/company-intro/image', formData, {
                headers: {
    ...
    const handleUpdateContent = async () => {
        ...
        try {
            const response = await axios.put('https://one-stop.ps/api/company-intro', {
                title: form.title,
    ...
    const handleDeleteImage = async (index) => {
        setLoading(true);
        try {
            await axios.delete(`https://one-stop.ps/api/company-intro/image/${index}`, {
                headers: { Authorization: `Bearer ${localStorage.getItem('token')}` },
