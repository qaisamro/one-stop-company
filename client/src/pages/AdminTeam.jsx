...
const AdminTeam = () => {
  ...
  const fetchTeam = async () => {
    setLoading(true);
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_URL}/api/team?lang=${form.language}`, {
  ...
  const handleAdd = async () => {
    ...
    try {
      await axios.post('${import.meta.env.VITE_API_URL}/api/team', formData, {
        headers: {
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(`${import.meta.env.VITE_API_URL}/api/team/${form.editingId}`, formData, {
        headers: {
          Authorization: `Bearer ${localStorage.getItem('token')}`,
          'Content-Type': 'multipart/form-data',
        },
